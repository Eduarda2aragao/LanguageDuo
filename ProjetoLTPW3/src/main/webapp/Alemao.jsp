...
<body>
  ...
  <div class="container">
    ...
    <h2 class="text-center page-title">Curso de Alemão</h2> 
    ...
    <div class="row">
      ...
      <div class="col-lg-7 pe-lg-4">
        <table class="table table-bordered table-striped table-hover">
          ...
          <tbody>
            <tr>
              <td><img src="./assets/img/Alemanha.jpg" alt="Bandeira Alemanha" class="flag-img" /></td>
              <td>Iniciante</td>
              <td>R$150,00</td>
              <td>Curso voltado para quem esta comecando do zero, com foco em vocabulario basico e conversacao simples.</td>
              <td>10/05/2025</td>
            </tr>
            <tr>
              <td><img src="./assets/img/Alemanha.jpg" alt="Bandeira Alemanha" class="flag-img" /></td>
              <td>Intermediario</td>
              <td>R$180,00</td>
              <td>Aprimore sua gramatica e amplie seu vocabulario com aulas dinamicas e exercicios praticos.</td>
              <td>15/05/2025</td>
            </tr>
            <tr>
              <td><img src="./assets/img/Alemanha.jpg" alt="Bandeira Alemanha" class="flag-img" /></td>
              <td>Avancado</td>
              <td>R$200,00</td>
              <td>Foco em fluencia, compreensao de textos complexos e conversacao avancada.</td>
              <td>20/05/2025</td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="notification-sidebar">
          ...
          <div class="notification-item info">
            ...
            <div class="notification-content">
              ...
              <div class="notification-text">Amanha as 15:00</div>
          ...
          <div class="notification-item success">
            ...
            <div class="notification-content">
              <div class="notification-title">Novo material dispon?vel</div>
              <div class="notification-text">No seu curso de Alem?o</div>
              <div class="notification-time">Ontem, 16:45</div>
            </div>
          </div>

          <div class="notification-footer">
            <a href="#"><i class="bi bi-bell"></i> Ver todas as notificações</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="row">
  <div class="col-md-4 mb-4">
    <div class="card">
      <img src="./assets/img/CachoAlemao.jpeg" class="card-img-top" alt="Curso Iniciante" />
      <div class="card-body">
        <h5 class="card-title">Alemao Iniciante</h5>
        <p class="card-text">Primeira aula dos iniciantes do Alemao. Introducaoo as primeiras palavras</p>
        <a href="#" class="btn btn-danger disabled" aria-disabled="true">Offline</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-4 mb-4">
    <div class="card">
      <img src="./assets/img/CachoAlemao.jpeg" class="card-img-top" alt="Curso Intermedi?rio" />
      <div class="card-body">
        <h5 class="card-title">Alemao Intermediario</h5>
        <p class="card-text">Aula de intermediarios no Alemao, aula de mídia, com conversacao e exercicios.</p>
        <a href="#" class="btn btn-danger disabled" aria-disabled="true">Offline</a>
      </div>
    </div>
  </div>
  ...
  <div class="col-md-4 mb-4">
    <div class="card">
      <img src="./assets/img/CachoAlemao.jpeg" class="card-img-top" alt="Curso Avan?ado" />
      <div class="card-body">
        <h5 class="card-title">Alemao Avancado</h5>
        <p class="card-text">Aula de conversa, focada em melhorar a pronuncia </p>
        <a href="#" class="btn btn-danger disabled" aria-disabled="true">Offline</a>
      </div>
    </div>
  </div>
