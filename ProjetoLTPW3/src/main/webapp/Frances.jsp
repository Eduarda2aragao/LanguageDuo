...
<body>
  ...
  <div class="container">
    ...
    <h2 class="text-center page-title">Curso de Frances</h2> 
    ...
    <div class="row">
      ...
      <div class="col-lg-7 pe-lg-4">
        <table class="table table-bordered table-striped table-hover">
          ...
          <tbody>
            <tr>
              <td><img src="./assets/img/Franca.png" alt="Bandeira Frances" class="flag-img" /></td>
              <td>Iniciante</td>
              <td>R$150,00</td>
              <td>Curso voltado para quem está começando do zero, com foco em vocabulario basico e conversação simples.</td>
              <td>10/05/2025</td>
            </tr>
            <tr>
              <td><img src="./assets/img/Franca.png" alt="Bandeira Frances" class="flag-img" /></td>
            ...
            <tr>
              ...
              <td>Avançado</td>
              <td>R$200,00</td>
              <td>Foco em fluencia, compreensão de textos complexos e conversação avan?ada.</td>
              <td>20/05/2025</td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="notification-sidebar">
          ...
          <div class="notification-item info">
            ...
            <div class="notification-content">
              ...
              <div class="notification-text">Amanh? ?s 15:00</div>
          ...
          <div class="notification-item success">
            ...
            <div class="notification-content">
              ...
              <div class="notification-text">No seu curso de Franc?s</div>
...
<div class="row">
  <div class="col-md-4 mb-4">
    <div class="card">
      <img src="./assets/img/Frango.jpg" class="card-img-top" alt="Curso Iniciante" />
      <div class="card-body">
        <h5 class="card-title">Frances Iniciante</h5>
        <p class="card-text">Primeira aula dos iniciantes do Frances. Introdução as primeiras palavras</p>
  ...
  <div class="col-md-4 mb-4">
    <div class="card">
      <img src="./assets/img/Frango.jpg" class="card-img-top" alt="Curso Intermedi?rio" />
      <div class="card-body">
        <h5 class="card-title">Frances Intermediário</h5>
  ...
  <div class="col-md-4 mb-4">
    <div class="card">
      <img src="./assets/img/Frango.jpg" class="card-img-top" alt="Curso Avan?ado" />
      <div class="card-body">
        <h5 class="card-title">Frances Avançado</h5>
        <p class="card-text">Aula de conversa, focada para melhorar a pronuncia do Frances para os avançados</p>
        <a href="#" class="btn btn-danger disabled" aria-disabled="true">Offline</a>
      </div>
    </div>
  </div>
