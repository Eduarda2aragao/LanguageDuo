...
<html lang="pt-br">
    ...
    <body>
        ...
        <div class="container">
            ...
            <h2 class="text-center page-title">Curso de Inglês</h2> 
            ...
            <div class="row">
                ...
                <div class="col-lg-7 pe-lg-4">
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td><img src="./assets/img/Bandeira.jpg" alt="Bandeira EUA" class="flag-img" /></td>
                                <td>Iniciante</td>
                                <td>R$150,00</td>
                    ...
                    <div class="notification-sidebar">
                        ...
                        <div class="notification-item success">
                            ...
                            <div class="notification-content">
                                ...
                                <div class="notification-text">No seu curso de Inglês</div>
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="./assets/img/Falcao.jpg" class="card-img-top" alt="Curso Iniciante" />
                        <div class="card-body">
                            <h5 class="card-title">Inglês Iniciante</h5>
                            <p class="card-text">Primeira aula dos inicantes do inglês- Introdução as primeiras palavras</p>
                            <a href="Professor.jsp#ingles" class="btn btn-primary">Professores</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="./assets/img/Falcao.jpg" class="card-img-top" alt="Curso Intermedi?rio" />
                        <div class="card-body">
                            <h5 class="card-title">Inglês Intermedi?rio</h5>
                            <p class="card-text">Terceira aula de intermediarios no ingles, aula voltada a inicio da temas mais avancados.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card">
                        <img src="./assets/img/Falcao.jpg" class="card-img-top" alt="Curso Avan?ado" />
                        <div class="card-body">
                            <h5 class="card-title">Inglês Avançado</h5>
                            <p class="card-text">Aula de conversa, focado para melhorar a pronuncia do inglês para os avançados</p>
                            <a href="Professor.jsp" class="btn btn-primary">Professores</a>
                        </div>
                    </div>
                </div>
