...
<body>
  ...
  <div class="container">
    ...
    <h2 class="text-center page-title">Curso de Português</h2> 
    ...
    <div class="row">
      ...
      <div class="col-lg-7 pe-lg-4">
        <table class="table table-bordered table-striped table-hover">
          ...
          <tbody>
            <tr>
              <td><img src="./assets/img/Brasil.jpg" alt="Bandeira Brasil" class="flag-img" /></td>
              <td>Iniciante</td>
              <td>R$150,00</td>
              <td>Curso voltado para quem esta começando do zero, com foco em vocabulario basico e conversação simples.</td>
              <td>10/05/2025</td>
            </tr>
            <tr>
              <td><img src="./assets/img/Brasil.jpg" alt="Bandeira Brasil" class="flag-img" /></td>
              <td>Intermediario</td>
              <td>R$180,00</td>
              <td>Aprimore sua gramática e amplie seu vocabulário com aulas dinamicas e exercícios práticos.</td>
              <td>15/05/2025</td>
            </tr>
            <tr>
              <td><img src="./assets/img/Brasil.jpg" alt="Bandeira Brasil" class="flag-img" /></td>
              <td>Avançado</td>
              <td>R$200,00</td>
              <td>Foco em fluência, compreensão de textos complexos e conversação avançada.</td>
              <td>20/05/2025</td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="notification-sidebar">
          ...
          <div class="notification-item success">
            ...
            <div class="notification-content">
              ...
              <div class="notification-text">No seu curso de Português</div>
    ...
    <div class="row">
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="./assets/img/CacchoBr.jpeg" class="card-img-top" alt="Curso Iniciante" />
          <div class="card-body">
            <h5 class="card-title">Português Iniciante</h5>
            <p class="card-text">Primeira aula dos iniciantes do Português. Introdução as primeiras palavras</p>
            <a href="Professor.jsp" class="btn btn-primary">Professores</a>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="./assets/img/CacchoBr.jpeg" class="card-img-top" alt="Curso Intermedi?rio" />
          <div class="card-body">
            <h5 class="card-title">Português Intermediário</h5>
      ...
      <div class="col-md-4 mb-4">
        <div class="card">
          <img src="./assets/img/CacchoBr.jpeg" class="card-img-top" alt="Curso Avan?ado" />
          <div class="card-body">
            <h5 class="card-title">Português Avançado</h5>
            <p class="card-text">Aula de conversa, focada para melhorar a pronuncia do Português para os avançados</p>
            <a href="Professor.jsp" class="btn btn-primary">Professores</a>
          </div>
        </div>
      </div>
